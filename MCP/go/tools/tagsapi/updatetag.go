...
func CreateUpdatetagTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_projects_projectId_tags_tagId",
		...
		mcp.WithString("description", mcp.Description("Input parameter: Gets or sets the description of the tag")),
		...
		mcp.WithString("name", mcp.Description("Input parameter: Gets or sets the name of the tag")),
	)
