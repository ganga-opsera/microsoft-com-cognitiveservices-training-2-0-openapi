...
func DeleteiterationHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeleteiterationTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_projects_projectId_iterations_iterationId",
		mcp.WithDescription("Delete a specific iteration of a project"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    DeleteiterationHandler(cfg),
	}
}
