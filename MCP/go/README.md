# TrainingApi MCP Server

This MCP (Model Content Protocol) server provides access to TrainingApi API functionality through HTTP, HTTPS, and STDIO transport modes.
